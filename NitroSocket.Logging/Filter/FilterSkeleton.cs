...
namespace Library.Logging.Filter
{
	/// <summary>
	...
	/// event filtering. Note that <see cref="Library.Logging.Repository.Hierarchy.Logger"/> and 
	/// <see cref="Library.Logging.Appender.AppenderSkeleton"/>, the parent class of all standard
