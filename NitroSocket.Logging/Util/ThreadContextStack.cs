...
{
	/// <summary>
	/// Implementation of Stack for the <see cref="Library.Logging.ThreadContext"/>
	/// </summary>
	/// <remarks>
	/// <para>
	/// Implementation of Stack for the <see cref="Library.Logging.ThreadContext"/>
	...
	public sealed class ThreadContextStack : IFixingRequired
	{
		...
		/// for example by using the <c>using(Library.Logging.ThreadContext.Stacks["NDC"].Push("Stack_Message"))</c> 
		/// syntax.
		/// </para>
		/// </remarks>
		public void Clear() 
		...
		/// <code lang="C#">
		/// using(Library.Logging.ThreadContext.Stacks["NDC"].Push("Stack_Message"))
		/// {
