...
namespace Library.Logging.Util.TypeConverters
{
	/// <summary>
	...
	public sealed class ConverterRegistry
	{
		...
		static ConverterRegistry()
		{
			...
			AddConverter(typeof(Library.Logging.Layout.PatternLayout), typeof(PatternLayoutConverter));
			AddConverter(typeof(Library.Logging.Util.PatternString), typeof(PatternStringConverter));
