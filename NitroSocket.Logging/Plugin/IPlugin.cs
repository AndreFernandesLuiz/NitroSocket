...
namespace Library.Logging.Plugin
{
	...
	/// with a <see cref="Library.Logging.Repository.ILoggerRepository"/>.
	/// The <see cref="PluginMap"/> held by the <see cref="Library.Logging.Repository.ILoggerRepository.PluginMap"/>
	/// property is used to store the plugins for a repository.
	/// </para>
	/// <para>
	/// The <c>Library.Logging.Config.PluginAttribute</c> can be used to
