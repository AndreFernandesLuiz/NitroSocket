...
using IRemoteLoggingSink = Library.Logging.Appender.RemotingAppender.IRemoteLoggingSink;

namespace Library.Logging.Plugin
{
	/// <summary>
	/// Plugin that listens for events from the <see cref="Library.Logging.Appender.RemotingAppender"/>
	/// </summary>
	/// <remarks>
	/// <para>
	...
	/// a remote <see cref="Library.Logging.Appender.RemotingAppender"/>.
	/// </para>
	/// <para>
