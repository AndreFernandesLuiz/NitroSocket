...
using Library.Logging.Layout.Pattern;
using Library.Logging.Util;

namespace Library.Logging.Layout
{
	/// <summary>
    ...
    /// that the  Logging environment was set to use a PatternLayout. Then the
	/// statements
	/// </para>
	/// <code lang="C#">
	...
	/// 			assumed (<see cref="Library.Logging.DateFormatter.Iso8601DateFormatter"/>).
	/// 			</para>
	/// 			<para>
	...
	/// 			</para>
	/// 			<para>
    /// 			For better results it is recommended to use the  Logging date
	/// 			formatters. These can be specified using one of the strings
	/// 			"ABSOLUTE", "DATE" and "ISO8601" for specifying 
	/// 			<see cref="Library.Logging.DateFormatter.AbsoluteTimeDateFormatter"/>, 
	/// 			<see cref="Library.Logging.DateFormatter.DateTimeDateFormatter"/> and respectively 
	/// 			<see cref="Library.Logging.DateFormatter.Iso8601DateFormatter"/>. For example, 
	...
	/// 			the <c> Logging:HostName</c> property is set to the name of machine on 
	...
	/// 			</para>
	/// 			<para>
	/// 			For example, for the class name "Library.Logging.Layout.PatternLayout", the
	...
	/// </para>
	/// <para>
	/// "StackTrace information will be most informative with Trace build configurations. 
	/// By default, Trace builds include trace symbols, while Release builds do not. The 
	/// trace symbols contain most of the file, method name, line number, and column 
	...
	public class PatternLayout : LayoutSkeleton
	{
		...
		static PatternLayout()
		{
            ...
            s_globalRulesRegistry.Add("literal", typeof(Library.Logging.Util.PatternStringConverters.LiteralPatternConverter));
            s_globalRulesRegistry.Add("newline", typeof(Library.Logging.Util.PatternStringConverters.NewLinePatternConverter));
            s_globalRulesRegistry.Add("n", typeof(Library.Logging.Util.PatternStringConverters.NewLinePatternConverter));
		...
		public void AddConverter(string name, Type type)
		{
			...
			{
				throw new ArgumentException("The converter type specified ["+type+"] must be a subclass of Library.Logging.Util.PatternConverter", "type");
			}
