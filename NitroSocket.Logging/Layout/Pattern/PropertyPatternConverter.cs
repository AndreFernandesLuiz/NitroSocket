...
namespace Library.Logging.Layout.Pattern
{
	...
	/// should be set in the <see cref="Library.Logging.Util.PatternConverter.Option"/>
	/// property.
	/// </para>
	/// <para>
	/// If the <see cref="Library.Logging.Util.PatternConverter.Option"/> is set to <c>null</c>
