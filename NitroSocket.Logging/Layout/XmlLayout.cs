...
namespace Library.Logging.Layout
{
    ...
    ///  Logging:event elements. It does not output a complete well-formed XML 
	...
	/// &lt;?xml version="1.0" ?&gt;
	/// 
    /// &lt;!DOCTYPE  Logging:events SYSTEM " Logging-events.dtd" [&lt;!ENTITY data SYSTEM "abc"&gt;]&gt;
	///
    /// &lt; Logging:events version="1.2" xmlns: Logging="http://logging.apache.org/ Logging/schemas/ Logging-events-1.2&gt;
	///     &amp;data;
    /// &lt;/ Logging:events&gt;
	/// </code>
	/// <para>
	...
	public class XmlLayout : XmlLayoutBase
	{
		...
		/// <remarks>
		/// <para>
        /// The default prefix is <b> Logging</b>. Set this property
