...
namespace Library.Logging.Appender 
{
	...
	/// on IP address 244.1.0.0 and port 8080 to the console. The event is 
	...
	/// IP 224.1.0.0 on port 8080:
	/// </para>
	/// <code lang="XML" escaped="true">
	/// <appender name="UdpAppender" type="Library.Logging.Appender.UdpAppender">
	///     <remoteAddress value="224.1.0.0" />
	///     <remotePort value="8080" />
	///     <layout type="Library.Logging.Layout.PatternLayout" value="%-5level %logger [%ndc] - %message%newline" />
	/// </appender>
	/// </code>
	/// </example>
	...
	public class UdpAppender : AppenderSkeleton
	{
		...
		/// <remarks>
		/// <para>
		/// Multicast addresses are identified by IP class <b>D</b> addresses (in the range 224.1.0.0 to
		...
		///     </item>
		///     <item>
		///         <term>224.1.0.02</term>
		///         <description>
		///             <para>
		///             The DHCP server answers messages on the IP address 224.1.0.02, but only on a subnet.
		///             </para>
		///         </description>
		///     </item>
		/// </list>
		...
		public int RemotePort
		{
			...
			set 
			{
				...
				{
                    throw Library.Logging.Util.SystemInfo.CreateArgumentOutOfRangeException("value", (object)value,
		...
		public override void ActivateOptions()
		{
			...
			{
                throw Library.Logging.Util.SystemInfo.CreateArgumentOutOfRangeException("this.RemotePort", (object)this.RemotePort,
			...
			{
                throw Library.Logging.Util.SystemInfo.CreateArgumentOutOfRangeException("this.LocalPort", (object)this.LocalPort,
