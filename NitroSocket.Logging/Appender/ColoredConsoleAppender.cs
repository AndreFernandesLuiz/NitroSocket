...
#if !SSCLI
// We don't want framework or platform specific code in the CLI version of  Logging
#if !CLI_1_0
...
namespace Library.Logging.Appender
{
	...
	/// </code>
	/// <para>
    /// The Level is the standard  Logging logging level and ForeColor and BackColor can be any
	...
	public class ColoredConsoleAppender : AppenderSkeleton
	{
		...
		/// <summary>
		/// This method is called by the <see cref="AppenderSkeleton.DoAppend(Library.Logging.Core.LoggingEvent)"/> method.
		/// </summary>
		...
		/// </para>
		/// </remarks>
        override protected void Append(Library.Logging.Core.LoggingEvent loggingEvent) 
		{
