...
namespace Library.Logging.Appender
{
	...
	/// </para>
	/// <para>
	/// Events are written using the <see cref="System.Diagnostics.Trace.Write(string,string)"/>
	...
	public class DebugAppender : AppenderSkeleton
	{
		...
		/// <para>
		/// Writes the logging event to the <see cref="System.Diagnostics.Trace"/> system.
		/// If <see cref="ImmediateFlush"/> is <c>true</c> then the <see cref="System.Diagnostics.Trace.Flush"/>
		/// is called.
		/// </para>
		/// </remarks>
