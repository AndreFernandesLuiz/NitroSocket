...
namespace Library.Logging.Core
{
	...
	/// <see cref="Library.Logging.Appender.IAppender.DoAppend"/> method.
	/// </para>
	/// <para>
	/// When objects that implement this interface are stored 
	/// in the context properties maps <see cref="Library.Logging.GlobalContext"/>
	/// <see cref="Library.Logging.GlobalContext.Properties"/> and <see cref="Library.Logging.ThreadContext"/>
	/// <see cref="Library.Logging.ThreadContext.Properties"/> are fixed 
