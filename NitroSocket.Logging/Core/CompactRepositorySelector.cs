...
namespace Library.Logging.Core
{
	...
	public class CompactRepositorySelector : IRepositorySelector
	{
		...
		public CompactRepositorySelector(Type defaultRepositoryType)
		{
			...
			{
				throw Library.Logging.Util.SystemInfo.CreateArgumentOutOfRangeException("defaultRepositoryType", (object)defaultRepositoryType, "Parameter: defaultRepositoryType, Value: ["+defaultRepositoryType+"] out of range. Argument must implement the ILoggerRepository interface");
			}

			m_defaultRepositoryType = defaultRepositoryType;

			LogLog.Trace("CompactRepositorySelector: defaultRepositoryType ["+m_defaultRepositoryType+"]");
		}
		...
		/// returned. The default repository is named <c> Logging-default-repository</c>.
		/// </para>
		/// </remarks>
		...
		/// repository is <c> Logging-default-repository</c>. Other repositories 
