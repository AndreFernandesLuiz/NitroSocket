...
namespace Library.Logging.Core
{
	...
	/// </para>
	/// <para>
	/// An alternative is to use the <c>Library.Logging.Config.SecurityContextProviderAttribute</c>
	/// This attribute can be applied to an assembly in the same way as the
	/// <c>Library.Logging.Config.XmlConfiguratorAttribute"</c>. The attribute takes
