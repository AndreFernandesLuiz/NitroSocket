...
namespace Library.Logging.Core
{
	...
	/// </para>
	/// <para>
	/// The levels that are recognized by  Logging are set for each <see cref="Library.Logging.Repository.ILoggerRepository"/>
	/// and each repository can have different levels defined. The levels are stored
	/// in the <see cref="Library.Logging.Repository.ILoggerRepository.LevelMap"/> on the repository. Levels are
	/// looked up by name from the <see cref="Library.Logging.Repository.ILoggerRepository.LevelMap"/>.
	/// </para>
	/// <para>
	...
	///		</item>
    ///		<item>
    ///			<description><see cref="BusinessError"/>.</description>
    ///		</item>
    ///		<item>
	...
	///		</item>
	///		<item>
	///			<description><see cref="Trace"/>.</description>
	///		</item>
	///		<item>
	...
	sealed public class Level : IComparable
	{
        ...
        /// <summary>
        /// The <see cref="BusinessError" /> level designates thta application execute 
        /// diferent path expected .
        /// </summary>
        public readonly static Level BusinessError = new Level(60001, "BUSINESSERROR");
		...
		/// events that are most useful to trace an application.
		/// </summary>
