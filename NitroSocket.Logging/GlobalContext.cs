...
namespace Library.Logging
{
	...
	/// be included in the output of log messages. The <see cref="Library.Logging.Layout.PatternLayout"/>
	/// supports selecting and outputing these properties.
	/// </para>
	/// <para>
    /// By default the <c> LoggingHostName</c> property is set to the name of 
	/// the current machine.
	/// </para>
	/// </remarks>
	/// <example>
	...
	public sealed class GlobalContext
	{
		...
		{
            Properties[Library.Logging.Core.LoggingEvent.HostNameProperty] = SystemInfo.HostName;
		}
