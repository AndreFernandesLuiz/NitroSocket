...
using Library.Logging.ObjectRenderer;

namespace Library.Logging.Repository.Hierarchy
{
    /// <summary>
    /// Initializes the  Logging environment using an XML DOM.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    public class XmlHierarchyConfigurator
    {
        ...
        public void Configure(XmlElement element)
        {
            ...
            {
                // Look for a trace attribute to enable internal trace
                string debugAttribute = element.GetAttribute(INTERNAL_DEBUG_ATTR);
                LogLog.Trace("XmlHierarchyConfigurator: " + INTERNAL_DEBUG_ATTR + " attribute [" + debugAttribute + "].");
                ...
                {
                    LogLog.Trace("XmlHierarchyConfigurator: Ignoring " + INTERNAL_DEBUG_ATTR + " attribute.");
                }
            ...
            LogLog.Trace("XmlHierarchyConfigurator: Configuration update mode [" + configUpdateMode.ToString() + "].");
            ...
            if (configUpdateMode == ConfigUpdateMode.Overwrite)
            {
                ...
                LogLog.Trace("XmlHierarchyConfigurator: Configuration reset before reading config.");
            }
            ...
            LogLog.Trace("XmlHierarchyConfigurator: Hierarchy Threshold [" + thresholdStr + "]");
        ...
        protected IAppender ParseAppender(XmlElement appenderElement)
        {
            ...
            LogLog.Trace("XmlHierarchyConfigurator: Loading Appender [" + appenderName + "] type: [" + typeName + "]");
            try
            {
                ...
                foreach (XmlNode currentNode in appenderElement.ChildNodes)
                {
                    ...
                    if (currentNode.NodeType == XmlNodeType.Element)
                    {
                        ...
                        if (currentElement.LocalName == APPENDER_REF_TAG)
                        {
                            ...
                            {
                                LogLog.Trace("XmlHierarchyConfigurator: Attaching appender named [" + refName + "] to appender named [" + appender.Name + "].");
                            ...
                            {
                                LogLog.Error("XmlHierarchyConfigurator: Requesting attachment of appender named [" + refName + "] to appender named [" + appender.Name + "] which does not implement Library.Logging.Core.IAppenderAttachable.");
                            }
                        }
                        else
                        {
                ...
                LogLog.Trace("XmlHierarchyConfigurator: Created Appender [" + appenderName + "]");
                return appender;
            }
            catch (Exception ex)
            {
        ...
        {
            // Create a new Library.Logging.Logger object from the <logger> element.
            string loggerName = loggerElement.GetAttribute(NAME_ATTR);

            LogLog.Trace("XmlHierarchyConfigurator: Retrieving an instance of Library.Logging.Repository.Logger for logger [" + loggerName + "].");
            ...
            lock (log)
            {
                ...
                LogLog.Trace("XmlHierarchyConfigurator: Setting [" + log.Name + "] additivity to [" + additivity + "].");
            ...
            foreach (XmlNode currentNode in catElement.ChildNodes)
            {
                if (currentNode.NodeType == XmlNodeType.Element)
                {
                    ...
                    if (currentElement.LocalName == APPENDER_REF_TAG)
                    {
                        ...
                        if (appender != null)
                        {
                            LogLog.Trace("XmlHierarchyConfigurator: Adding appender named [" + refName + "] to logger [" + log.Name + "].");
        ...
        protected void ParseRenderer(XmlElement element)
        {
            ...
            LogLog.Trace("XmlHierarchyConfigurator: Rendering class [" + renderingClassName + "], Rendered class [" + renderedClassName + "].");
        ...
        protected void ParseLevel(XmlElement element, Logger log, bool isRoot)
        {
            ...
            LogLog.Trace("XmlHierarchyConfigurator: Logger [" + loggerName + "] Level string is [" + levelStr + "].");
            ...
            if (INHERITED == levelStr)
            {
                ...
                {
                    LogLog.Trace("XmlHierarchyConfigurator: Logger [" + loggerName + "] level set to inherit from parent.");
                    log.Level = null;
                }
            }
            else
            {
                ...
                {
                    LogLog.Trace("XmlHierarchyConfigurator: Logger [" + loggerName + "] level set to [name=\"" + log.Level.Name + "\",value=" + log.Level.Value + "].");
                }
            }
        }
            ...
            else
            {
                ...
                if (propertyValue != null)
                {
                    ...
                    catch (System.Security.SecurityException)
                    {
                        ...
                        LogLog.Trace("XmlHierarchyConfigurator: Security exception while trying to expand environment variables. Error Ignored. No Expansion.");
                    }
#endif
                    ...
                    if (subTypeString != null && subTypeString.Length > 0)
                    {
                        ...
                        try
                        {
                            ...
                            LogLog.Trace("XmlHierarchyConfigurator: Parameter [" + name + "] specified subtype [" + subType.FullName + "]");
                    ...
                    {
                        LogLog.Trace("XmlHierarchyConfigurator: Performing additional conversion of value from [" + convertedValue.GetType().Name + "] to [" + parsedObjectConversionTargetType.Name + "]");
                    ...
                    if (convertedValue != null)
                    {
                        if (propInfo != null)
                        {
                            ...
                            LogLog.Trace("XmlHierarchyConfigurator: Setting Property [" + propInfo.Name + "] to " + convertedValue.GetType().Name + " value [" + convertedValue.ToString() + "]");
                        ...
                        {
                            // Got a converted result
                            LogLog.Trace("XmlHierarchyConfigurator: Setting Collection Property [" + methInfo.Name + "] to " + convertedValue.GetType().Name + " value [" + convertedValue.ToString() + "]");
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            // Got a converted result
                            LogLog.Trace("XmlHierarchyConfigurator: Setting Property [" + propInfo.Name + "] to object [" + createdObject + "]");
                        ...
                        {
                            // Got a converted result
                            LogLog.Trace("XmlHierarchyConfigurator: Setting Collection Property [" + methInfo.Name + "] to object [" + createdObject + "]");
        ...
        protected object CreateObjectFromXml(XmlElement element, Type defaultTargetType, Type typeConstraint)
        {
            ...
            object createdObject = null;
            object createdObjectAdpt = new object();
            ...
            try
            {
                ...
                if (requiresConversion)
                {
                    ...
                    createdObjectAdpt = OptionConverter.ConvertTypeTo(createdObject, typeConstraint);
                }
                else
                {
                    // The object is of the correct type
                    createdObjectAdpt = createdObject;
                }
        ...
        private const string INTERNAL_DEBUG_ATTR = "trace";
