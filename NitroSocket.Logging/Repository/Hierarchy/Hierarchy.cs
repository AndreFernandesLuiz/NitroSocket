...
namespace Library.Logging.Repository.Hierarchy
{
    ...
    public class Hierarchy : LoggerRepositorySkeleton, IBasicRepositoryConfigurator, IXmlRepositoryConfigurator
    {
        ...
        {
            LogLog.Trace("Hierarchy: Shutdown called on Hierarchy [" + this.Name + "]");
        ...
        /// using the <see cref="Library.Logging.LogManager.GetLogger(string)"/> method.
        /// </para>
        /// <para>
        ...
        override public void Log(LoggingEvent logEvent)
        {
            ...
            Logger logger = this.GetLogger(logEvent.LoggerName, m_defaultFactory);
            if (logger != null)
            {
                logger.Log(logEvent);
            }
        ...
        /// <remarks>
        /// <para>
        /// Returns all the <see cref="Library.Logging.Appender.IAppender"/> instances that are currently configured.
        ...
        /// </para>
        /// </remarks>
        override public Library.Logging.Appender.IAppender[] GetAppenders()
        {
            ...
            return (Library.Logging.Appender.IAppender[])appenderList.ToArray(typeof(Library.Logging.Appender.IAppender));
        }
        ...
        {
            foreach (Library.Logging.Appender.IAppender appender in container.Appenders)
            {
        ...
        /// <summary>
        /// Initialize the  Logging system using the specified config
        /// </summary>
        ...
        internal class LevelEntry
        {
            ...
            /// <summary>
            /// Override <c>Object.ToString</c> to return sensible trace info
            /// </summary>
