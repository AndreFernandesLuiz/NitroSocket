...
using Library.Logging.Plugin;

namespace Library.Logging.Repository
{
	/// <summary>
	...
	public abstract class LoggerRepositorySkeleton : ILoggerRepository
	{
		...
		/// </para>
		/// </remarks>
        abstract public Library.Logging.Appender.IAppender[] GetAppenders();
		...
		private void AddBuiltinLevels()
		{
			...
			// Information
            m_levelMap.Add(Level.BusinessError); 
