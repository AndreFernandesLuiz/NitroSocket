...
namespace Library.Logging.Repository
{
	...
	/// with a default <see cref="Library.Logging.Appender.IAppender"/>.
	/// </para>
	/// <para>
	/// A <see cref="ILoggerRepository"/> should implement this interface to support
	/// configuration by the <see cref="Library.Logging.Config.BasicConfigurator"/>.
	/// </para>
	/// </remarks>
	...
	public interface IBasicRepositoryConfigurator
	{
		...
		/// </para>
		/// </remarks>
        void Configure(Library.Logging.Appender.IAppender appender);
	}
}
